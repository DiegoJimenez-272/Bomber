...
# Parche para omitir la estricta verificación de versión de base de datos de Django (Ideal para XAMPP)
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATES_DIR],
        'APP_DIRS': True, # Esto le dice a Django que busque plantillas dentro de las carpetas de las aplicaciones
        'OPTIONS': {
            'context_processors': [
